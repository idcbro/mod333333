...
banEmbed("#DSA",`${victim.user.tag} kişisi sunucumuz sınırlarından ${author} tarafından **__${reason}__** sebebi ile kovuldu`,message,[false])
...
exports.commandSettings = {
    ...
    guildOnly: true, 
    coolDown: 0, 
    description: "ban @Λrda/852956127728762890 [Sebep]"
}