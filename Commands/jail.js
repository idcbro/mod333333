...
exports.run = async(client, message, args, author, victim) => {
    ...
    let sunucu = client.guilds.cache.get(ayarlar.guildSettings.guildID);
     ...
     if(!author.roles.cache.has(ayarlar.guildHammer.jailHammer) && !author.hasPermission("ADMINISTRATOR"))  return permEmbed(message)
...
exports.commandSettings = {
    ...
    guildOnly: true, 
    coolDown: 3000, 
    description: "jail @Λrda/852956127728762890 [Sebep]"
}