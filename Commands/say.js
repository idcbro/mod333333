...
const tagliUye = message.guild.members.cache.filter(x => x.roles.cache.has(ayarlar.reg.familyRole)).size
let discMembers = message.guild.members.cache.filter(x => x.user.discriminator == ayarlar.guildSettings.etiket).size;
