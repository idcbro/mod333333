...
exports.run = async(client, message, args, author, victim) => {
    if(!author.roles.cache.has(ayarlar.guildHammer.jailHammer) && !author.hasPermission("MANAGE_ROLES")) return permEmbed(message)
let time = args[1]
...
exports.commandSettings = {
    ...
    guildOnly: true, 
    coolDown: 3000, 
    description: "tempjail @Λrda/852956127728762890 [Süre] [Sebep]"
}