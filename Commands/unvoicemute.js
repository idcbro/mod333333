...
if(!message.member.roles.cache.has(ayarlar.guildHammer.muteHammer) && !message.member.hasPermission("ADMINISTRATOR")) return permEmbed(message)
...
victim.roles.remove(ayarlar.guildRoles.vmuteRole)
...
exports.commandSettings = {
    ...
    guildOnly: true, 
    coolDown: 3000, 
    description: "unmute @Λrda/852956127728762890 [Sebep]"
}