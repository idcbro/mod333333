...
exports.run = async(client, message, args, author, victim) => {
    if(!author.roles.cache.has(ayarlar.guildHammer.vmuteHammer) && !author.hasPermission("MANAGE_ROLES")) return permEmbed(message)
let time = args[1]
...
rolVer(victim.id,ayarlar.guildRoles.vmuteRole)
...
exports.commandSettings = {
    ...
    guildOnly: true, 
    coolDown: 3000, 
    description: "vmute @Λrda/852956127728762890 [Süre] [Sebep]"
}
