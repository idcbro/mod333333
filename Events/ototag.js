...
module.exports = async(oldUser, newUser) => {
    ...
    const taglog = guild.channels.cache.get(ayarlar.tagLogs);
    const ailerol = ayarlar.reg.familyRole
    const tag = ayarlar.guildSettings.tag
    const etiket = ayarlar.guildSettings.etiket

    const tik = ayarlar.emojiler.onay
    const red = ayarlar.emojiler.red
